    ...
    <>
      ...
      >
        <div className={`lg:h-[${Props.image.height}] w-[${Props.image.width}] border-2 rounded-lg duration-200 hover:scale-105 shadow-2xl relative group ease-in-out`}>
          ...
          <Image src={Props.image.url} alt={Props.info.name} height={Props.image.height} width={Props.image.width} className={' object-cover rounded-lg rounded-b-none lg:rounded-lg'} />
