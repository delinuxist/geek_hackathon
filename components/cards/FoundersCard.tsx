          ...
          <div className='relative w-full h-[400px]'>
            ...
            <div
              ...
              <div className="invisible group-hover:delay-200 group-hover:visible">
                ...
                <CustomButton containerStyles={'bg-inspiration rounded-md mt-2 ease-in-out  py-2 hover:scale-105 hover:text-white text-software-grey font-bold'} title="Read More" />
              </div>
            </div>
          </div>
