        ...
        <Dialog as='div' className='relative z-[100]' onClose={Props.closeModal}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            <div className='flex items-center justify-center min-h-full p-4 text-center'>
              ...
              >
                <Dialog.Panel className={`relative w-full max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5 ${Props.containerStyles ? Props.containerStyles : "max-w-lg"}`}>
                  <button
                    type='button'
