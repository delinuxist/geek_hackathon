...
const ServicesSection = () => {
    ...
    return (
        <>
                ...
                <div className="p-6 mb-2 bg-transparent serv-sec">
                    <div className="grid items-center grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <br />
                            <a className="py-2 text-xl font-extrabold cursor-pointer learn-more-link font-mondwest text-pixel-black" onClick={() => openModal("development")}>
                ...
                <div className="p-6 mb-2 bg-transparent serv-sec">
                    <div className="grid items-center grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <br />
                            <a className="py-2 text-xl font-extrabold cursor-pointer learn-more-link font-mondwest text-pixel-black" onClick={() => openModal("projectManagement")}>
                                Learn More <span className="arrow">&#8594;</span>
                            </a>
                        </div>
                        <div className='flex items-center justify-center'>
                ...
                <div className="p-6 mb-2 bg-transparent">
                    <div className="grid items-center grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <br />
                            <a className="py-2 text-xl font-extrabold cursor-pointer learn-more-link font-mondwest text-pixel-black" onClick={() => openModal("partnership")}>
                                Learn More <span className="arrow">&#8594;</span>
                            </a>
                        </div>
                    </div>
                ...
                <div className="p-5 mb-2 bg-transparent serv-sec">
                    <div className="grid items-center grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <br />
                            <a className="py-2 text-xl font-extrabold cursor-pointer learn-more-link font-mondwest text-pixel-black" onClick={() => openModal("softwareConsultancy")}>
                                Learn More <span className="arrow">&#8594;</span>
                            </a>
                        </div>
                        <div className='flex items-center justify-center'>
            ...
            <ModalWrapper isOpen={isOpen} closeModal={closeModal} containerStyles=' max-w-xl'>
